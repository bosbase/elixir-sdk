defmodule Bosbase.VectorService do
  ...
  def insert(client, doc, collection \\ "", query \\ %{}, headers \\ %{}) do
    Client.send(client, collection_path("/api/vectors", collection), %{
      method: :post,
      body: doc,
      query: query,
      headers: headers
  ...
  def batch_insert(client, opts, collection \\ "", query \\ %{}, headers \\ %{}) do
    Client.send(client, collection_path("/api/vectors", collection) <> "/documents/batch", %{
      method: :post,
      body: opts,
      query: query,
      headers: headers
  ...
  def update(client, document_id, doc, collection \\ "", query \\ %{}, headers \\ %{}) do
    ...
    Client.send(client, path, %{method: :patch, body: doc, query: query, headers: headers})
  end
  ...
  def delete(client, document_id, collection \\ "", body \\ %{}, query \\ %{}, headers \\ %{}) do
    ...
    Client.send(client, path, %{method: :delete, body: body, query: query, headers: headers})
    |> case do
      {:ok, _} -> :ok
      other -> other
    end
  ...
  def search(client, options, collection \\ "", query \\ %{}, headers \\ %{}) do
    Client.send(client, collection_path("/api/vectors", collection) <> "/documents/search", %{
      method: :post,
      body: options,
      query: query,
      headers: headers
  ...
  def list(client, collection \\ "", page \\ nil, per_page \\ nil, query \\ %{}, headers \\ %{}) do
    ...
    Client.send(client, collection_path("/api/vectors", collection), %{query: params, headers: headers})
  end

  def create_collection(client, name, config, query \\ %{}, headers \\ %{}) do
    Client.send(client, "/api/vectors/collections/#{Utils.encode_path_segment(name)}", %{
      method: :post,
      body: config,
      query: query,
      headers: headers
  ...
  def list_collections(client, query \\ %{}, headers \\ %{}) do
    Client.send(client, "/api/vectors/collections", %{query: query, headers: headers})
  end
